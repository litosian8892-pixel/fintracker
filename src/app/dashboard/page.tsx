...
export default function FintrackerApp() {
  ...
  const [accAccountNumber, setAccAccountNumber] = useState(""); // FITUR BARU: NOMOR REKENING
  ...
  const [editAccAccountNumber, setEditAccAccountNumber] = useState(""); // FITUR BARU: NOMOR REKENING EDIT
