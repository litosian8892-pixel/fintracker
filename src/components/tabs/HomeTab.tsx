...
interface HomeTabProps {
  ...
  tAdminFee: string; setTAdminFee: (val: string) => void; // <--- PROPS BARU
  ...
  return (
    <div className="space-y-6 animate-in fade-in relative">
      <div className="bg-white p-6 rounded-[30px] border border-slate-200 shadow-sm space-y-4 relative z-10">
        ...
        {/* DOMPET TUJUAN (HANYA MUNCUL DI TRANSFER) */}
        {tType === "transfer" && (
        ...
        {/* INPUT BIAYA ADMIN BARU (HANYA MUNCUL DI MODE TRANSFER) */}
        {tType === "transfer" && (
          <input 
            type="number" 
